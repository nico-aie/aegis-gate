...
**Component:** [config.rs:1780-1788](aegis-gate/crates/aegis-core/src/config.rs#L1780-L1788) + DLP regexes line 2263
...
**Component:** [config.rs:1804-1815](aegis-gate/crates/aegis-core/src/config.rs#L1804-L1815)
...
**Component:** [config.rs:723](aegis-gate/crates/aegis-core/src/config.rs#L723)
...
**Component:** [config.rs:1689-1697](aegis-gate/crates/aegis-core/src/config.rs#L1689-L1697)
Bare `backend: redis` with `redis: None` parses; should fail at `validate()`.

### M-05 · `RedisConfig.urls: Vec<String>` unvalidated
**Component:** [config.rs:1759-1767](aegis-gate/crates/aegis-core/src/config.rs#L1759-L1767)
Typos like `redi://...` silently pass. Parse each URL in `validate()`.

### M-06 · `MemberConfig.host_header` SNI gap docstring not in top-level
**Component:** [config.rs:1396-1426](aegis-gate/crates/aegis-core/src/config.rs#L1396-L1426)
...
**Component:** [config.rs:2304-2330](aegis-gate/crates/aegis-core/src/config.rs#L2304-L2330)
...
**Component:** [config.rs:380-533](aegis-gate/crates/aegis-core/src/config.rs#L380-L533)
...
**Component:** [config.rs:2222-2236](aegis-gate/crates/aegis-core/src/config.rs#L2222-L2236)
`*.*.example.com` or bare `*` silently slips through.

### M-10 · Test-asserted hardcoded values pin operator-facing defaults
**Component:** [config.rs:2873-2879, 3063-3083](aegis-gate/crates/aegis-core/src/config.rs#L2873-L2879)
...
**Component:** [config.rs:14-20](aegis-gate/crates/aegis-core/src/config.rs#L14-L20)
...
**Component:** [config.rs root](aegis-gate/crates/aegis-core/src/config.rs)
...
**Component:** [config.rs:2106-2109](aegis-gate/crates/aegis-core/src/config.rs#L2106-L2109)
...
**Component:** [config.rs:2389](aegis-gate/crates/aegis-core/src/config.rs#L2389)
...
**Component:** [audit.rs (entire file)](aegis-gate/crates/aegis-core/src/audit.rs)
§5.6 dashboard audit log includes `device_fp`. Add `pub device_fp: Option<String>`.

### M-16 · `AuditBus` swallows send failures silently
**Component:** [audit.rs:31-45](aegis-gate/crates/aegis-core/src/audit.rs#L31-L45)
...
**Component:** [tier.rs:21-23](aegis-gate/crates/aegis-core/src/tier.rs#L21-L23)
...
**Component:** [load_mode.rs (entire file)](aegis-gate/crates/aegis-core/src/load_mode.rs)
...
**Component:** [load_mode.rs:296](aegis-gate/crates/aegis-core/src/load_mode.rs#L296)
...
**Component:** [load_mode.rs:245](aegis-gate/crates/aegis-core/src/load_mode.rs#L245)
...
**Component:** [state.rs:154-155](aegis-gate/crates/aegis-core/src/state.rs#L154-L155)
No clamp documented. Document saturation semantics.

### M-22 · `health()` default returns `connected: true`
**Component:** [state.rs:170](aegis-gate/crates/aegis-core/src/state.rs#L170)
...
**Component:** [pipeline.rs:48](aegis-gate/crates/aegis-core/src/pipeline.rs#L48)
...
**Component:** [tcp_destination.rs:128-129](aegis-gate/crates/aegis-core/src/tcp_destination.rs#L128-L129)
...
**Component:** [tcp_destination.rs:215-226](aegis-gate/crates/aegis-core/src/tcp_destination.rs#L215-L226)
...
**Component:** [break_glass.rs:47-56](aegis-gate/crates/aegis-core/src/break_glass.rs#L47-L56)
...
**Component:** [break_glass.rs:38-40](aegis-gate/crates/aegis-core/src/break_glass.rs#L38-L40)
...
**Component:** [sd.rs:3-8](aegis-gate/crates/aegis-core/src/sd.rs#L3-L8)
...
**Component:** [sd.rs:11-15](aegis-gate/crates/aegis-core/src/sd.rs#L11-L15)
...
**Component:** [lib.rs:23-42](aegis-gate/crates/aegis-core/src/lib.rs#L23-L42)
