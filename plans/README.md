...
|---|---|---|---|---|
| **Active** | Hackathon Round-1 stress-test prep — 15-min mixed-traffic harness | [`hackathon-stress-test.md`](./hackathon-stress-test.md) | — (prep only) | Harness scaffolded under `tests/hackathon/`. **Three runs done**: (a) v1 15-min baseline 33 % detection, (b) v2 15-min post-detector-coverage sprint **80 % detection** (`run-perf-15min-2026-05-02-v2/`), (c) **prod-balanced @ 5 k+ RPS sustained** with Go upstream — **4 891 RPS k6 / 6 392 RPS WAF-internal, legit p99 1.03 ms, legit OK 100 %, 80 % detection** (`run-perf-5krps-prod-balanced-2026-05-02-v3/REPORT.md`). 100 %-of-detected attacks prevented. Awaiting benchmark team inputs — see plan §8. |
