...
(function() {
  ...
  function PageOverview() {
    ...
    const dist = window.ATTACK_CATS.map((c) => ({
      name: c.label,
      color: c.color,
      value: 50 + Math.floor(Math.random() * 600 + (c.id === "ssrf" ? 400 : 0) + (c.id === "sqli" ? 300 : 0))
    }));
    const blips = window.ATTACKER_GEO.slice(0, 12).map((g, i) => ({
      ...g,
      label: `${g.cc} \xB7 ${g.city}`,
      show: i < 5
    }));
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "page-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", { className: "page-title" }, "Overview"), /* @__PURE__ */ React.createElement("p", { className: "page-subtitle" }, "Realtime WAF traffic monitoring \xB7 5-cluster deployment \xB7 last update ", tick, "s")), /* @__PURE__ */ React.createElement("div", { className: "page-actions" }, /* @__PURE__ */ React.createElement("button", { className: "btn" }, /* @__PURE__ */ React.createElement(window.I.Refresh, null), " Refresh"), /* @__PURE__ */ React.createElement("button", { className: "btn" }, /* @__PURE__ */ React.createElement(window.I.Download, null), " Export"), /* @__PURE__ */ React.createElement("button", { className: "btn primary" }, /* @__PURE__ */ React.createElement(window.I.External, null), " Open Grafana"))), /* @__PURE__ */ React.createElement("div", { className: "ai-card ai-soon", style: { marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10 } }, /* @__PURE__ */ React.createElement("span", { className: "ai-tag" }, /* @__PURE__ */ React.createElement(window.I.Sparkles, null), " AI INSIGHTS"), /* @__PURE__ */ React.createElement("span", { className: "pill warn" }, "Coming soon"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, color: "var(--ink-mute)" } }, "Automated threat triage & suggested rules \u2014 early access in v1.5"), /* @__PURE__ */ React.createElement("button", { className: "btn sm ghost", style: { marginLeft: "auto" }, disabled: true }, "Notify me \u2192"))), /* @__PURE__ */ React.createElement("div", { className: "kpi-row" }, /* @__PURE__ */ React.createElement(
      window.StatTile,
      {
        ...
        sub: /* @__PURE__ */ React.createElement(React.Fragment, null, "last 10 seconds ", /* @__PURE__ */ React.createElement("span", { style: { color: "var(--up)" } }, /* @__PURE__ */ React.createElement(window.I.ArrowUp, null), " 12%")),
      ...
      window.StatTile,
      {
        title: "Block rate",
        value: `${blockRate}%`,
        sub: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { className: "num" }, totalBlocks.toLocaleString()), " blocked total"),
      ...
      window.StatTile,
      {
        ...
        value: "47",
        sub: /* @__PURE__ */ React.createElement(React.Fragment, null, "IPs over risk threshold \xB7 ", /* @__PURE__ */ React.createElement("span", { style: { color: "var(--down)" } }, "3 critical")),
...
`;
  ...
  function PageTierConfig() {
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "page-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", { className: "page-title" }, "Tier Config"), /* @__PURE__ */ React.createElement("p", { className: "page-subtitle" }, "Pipeline assignment per tier \xB7 4 active tiers \xB7 60 routes assigned")), /* @__PURE__ */ React.createElement("div", { className: "page-actions" }, /* @__PURE__ */ React.createElement("button", { className: "btn primary" }, /* @__PURE__ */ React.createElement(window.I.Plus, null), " New tier"))), /* @__PURE__ */ React.createElement("div", { className: "split-list" }, /* @__PURE__ */ React.createElement("div", { className: "left" }, /* @__PURE__ */ React.createElement("div", { style: { overflow: "auto", flex: 1 } }, window.TIERS.map((t) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: t.name,
      ...
      /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--ink-dim)", marginBottom: 6 } }, t.desc),
      /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, fontSize: 10 } }, /* @__PURE__ */ React.createElement("span", { className: "pill neutral" }, t.routes, " routes"), /* @__PURE__ */ React.createElement("span", { className: "pill neutral" }, t.detectors, "/7 detectors"))
    )))), /* @__PURE__ */ React.createElement("div", { className: "right", style: { padding: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, marginBottom: 14 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 16, fontWeight: 700 } }, selected.name), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--ink-dim)" } }, selected.desc, " \xB7 ", /* @__PURE__ */ React.createElement("span", { className: "num" }, selected.hits1h.toLocaleString()), " req/1h")), /* @__PURE__ */ React.createElement("div", { style: { marginLeft: "auto", display: "flex", gap: 6 } }, /* @__PURE__ */ React.createElement("button", { className: "btn" }, "Cancel"), /* @__PURE__ */ React.createElement("button", { className: "btn primary" }, "Save tier"))), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 } }, [
      { name: "TLS profile", icon: "\u{1F512}", val: selected.tls, opts: ["fips", "modern", "compat"] },
      { name: "Rate-limit profile", icon: "\u23F1", val: selected.rateLimit, opts: ["lenient", "standard", "strict"] },
      { name: "Challenge ladder", icon: "\u{1F6E1}", val: selected.challenge, opts: ["none", "js-only", "js+captcha", "strict"] },
      { name: "DLP action", icon: "\u{1F510}", val: "mask", opts: ["audit_only", "mask", "block"] }
    ].map((s) => /* @__PURE__ */ React.createElement("div", { key: s.name, style: { background: "var(--canvas-2)", border: "1px solid var(--hairline)", borderRadius: 6, padding: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: 600 } }, s.name), /* @__PURE__ */ React.createElement("div", { className: `toggle on`, style: { marginLeft: "auto" } })), /* @__PURE__ */ React.createElement("select", { className: "input select", defaultValue: s.val }, s.opts.map((o) => /* @__PURE__ */ React.createElement("option", { key: o }, o)))))), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 16, background: "var(--canvas-2)", border: "1px solid var(--hairline)", borderRadius: 6, padding: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: 600, marginBottom: 10 } }, "Detector set (", selected.detectors, "/7 enabled)"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 8 } }, ["sqli", "xss", "path_traversal", "ssrf", "header_injection", "body_abuse", "recon"].map((d, i) => /* @__PURE__ */ React.createElement("label", { key: d, style: { display: "flex", alignItems: "center", gap: 6, fontSize: 12, padding: "6px 8px", background: "var(--surface-2)", borderRadius: 4 } }, /* @__PURE__ */ React.createElement("div", { className: `toggle ${i < selected.detectors ? "on" : ""}`, style: { width: 28, height: 16 } }), /* @__PURE__ */ React.createElement("span", null, d))))), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: 600, marginBottom: 8 } }, "Routes assigned (", selected.routes, ")"), /* @__PURE__ */ React.createElement("table", { className: "tbl tbl-compact" }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", null, "Route"), /* @__PURE__ */ React.createElement("th", null, "Method"), /* @__PURE__ */ React.createElement("th", null, "Hits 1h"), /* @__PURE__ */ React.createElement("th", null, "Avg risk"))), /* @__PURE__ */ React.createElement("tbody", null, window.ROUTES.slice(0, 6).map((r) => /* @__PURE__ */ React.createElement("tr", { key: r }, /* @__PURE__ */ React.createElement("td", { className: "mono" }, r), /* @__PURE__ */ React.createElement("td", { className: "mono dim" }, "ANY"), /* @__PURE__ */ React.createElement("td", { className: "num" }, Math.floor(Math.random() * 8e3).toLocaleString()), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement(window.RiskMeter, { value: Math.floor(Math.random() * 60) }))))))))));
  }
  function ListPage({ kind }) {
    const isBL = kind === "blacklist";
    const data = isBL ? window.BLACKLIST : window.WHITELIST;
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "page-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", { className: "page-title" }, isBL ? "Blacklist" : "Whitelist"), /* @__PURE__ */ React.createElement("p", { className: "page-subtitle" }, data.length, " entries \xB7", /* @__PURE__ */ React.createElement("span", { className: "num" }, " ", data.reduce((s, x) => s + (isBL ? x.hits24 : x.bypasses24), 0).toLocaleString()), " ", isBL ? "hits" : "bypasses", " in 24h")), /* @__PURE__ */ React.createElement("div", { className: "page-actions" }, /* @__PURE__ */ React.createElement("button", { className: "btn" }, /* @__PURE__ */ React.createElement(window.I.Download, null), " Bulk import"), /* @__PURE__ */ React.createElement("button", { className: "btn primary" }, /* @__PURE__ */ React.createElement(window.I.Plus, null), " Add entry"))), /* @__PURE__ */ React.createElement("div", { className: "card flat", style: { padding: 12, marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("select", { className: "input select", style: { width: 130 } }, /* @__PURE__ */ React.createElement("option", null, "All types"), /* @__PURE__ */ React.createElement("option", null, "IP"), /* @__PURE__ */ React.createElement("option", null, "CIDR"), /* @__PURE__ */ React.createElement("option", null, "ASN"), /* @__PURE__ */ React.createElement("option", null, "Country"), /* @__PURE__ */ React.createElement("option", null, "Fingerprint")), /* @__PURE__ */ React.createElement("select", { className: "input select", style: { width: 130 } }, /* @__PURE__ */ React.createElement("option", null, "All scopes"), /* @__PURE__ */ React.createElement("option", null, "global"), /* @__PURE__ */ React.createElement("option", null, "per-route"), /* @__PURE__ */ React.createElement("option", null, "per-tier")), /* @__PURE__ */ React.createElement("select", { className: "input select", style: { width: 110 } }, /* @__PURE__ */ React.createElement("option", null, "Active"), /* @__PURE__ */ React.createElement("option", null, "Expired"), /* @__PURE__ */ React.createElement("option", null, "All")), /* @__PURE__ */ React.createElement("input", { className: "input", style: { flex: 1, maxWidth: 320 }, placeholder: "Search by value, reason\u2026" }))), /* @__PURE__ */ React.createElement("div", { className: "card", style: { padding: 0 } }, /* @__PURE__ */ React.createElement("table", { className: "tbl tbl-compact" }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", { style: { width: 90 } }, "Type"), /* @__PURE__ */ React.createElement("th", null, "Value"), /* @__PURE__ */ React.createElement("th", { style: { width: 160 } }, "Scope"), /* @__PURE__ */ React.createElement("th", { style: { width: 130 } }, isBL ? "Action" : "Bypass"), /* @__PURE__ */ React.createElement("th", null, "Reason"), /* @__PURE__ */ React.createElement("th", { style: { width: 110 } }, "Expires"), /* @__PURE__ */ React.createElement("th", { style: { width: 90 } }, isBL ? "Hits 24h" : "Bypasses 24h"), /* @__PURE__ */ React.createElement("th", { style: { width: 100 } }, "Last"), /* @__PURE__ */ React.createElement("th", { style: { width: 60 } }))), /* @__PURE__ */ React.createElement("tbody", null, data.map((e) => /* @__PURE__ */ React.createElement("tr", { key: e.id }, /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("span", { className: `pill ${e.type === "country" ? "solid-yellow" : "neutral"}` }, e.type)), /* @__PURE__ */ React.createElement("td", { className: "mono", style: { color: "var(--ink-strong)" } }, e.type === "country" ? /* @__PURE__ */ React.createElement("span", { style: { display: "inline-flex", alignItems: "center", gap: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 16, lineHeight: 1 } }, e.flag), /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 600 } }, e.value), /* @__PURE__ */ React.createElement("span", { className: "dim", style: { fontFamily: "var(--font-sans)", fontWeight: 400 } }, e.country)) : e.value), /* @__PURE__ */ React.createElement("td", { className: "mono dim" }, e.scope), /* @__PURE__ */ React.createElement("td", null, isBL ? /* @__PURE__ */ React.createElement(window.ActionPill, { value: e.action }) : /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4, flexWrap: "wrap" } }, e.bypass.includes("all") ? /* @__PURE__ */ React.createElement("span", { className: "pill solid-yellow" }, "all \xB7 high-trust") : e.bypass.map((b) => /* @__PURE__ */ React.createElement("span", { key: b, className: "pill neutral", style: { fontSize: 9 } }, b)))), /* @__PURE__ */ React.createElement("td", { className: "dim", style: { maxWidth: 280, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, e.reason), /* @__PURE__ */ React.createElement("td", { className: "num", style: { color: e.expires ? "var(--warn)" : "var(--ink-dim)" } }, e.expires ? e.expires.slice(0, 10) : "never"), /* @__PURE__ */ React.createElement("td", { className: "num" }, (isBL ? e.hits24 : e.bypasses24).toLocaleString()), /* @__PURE__ */ React.createElement("td", { className: "dim" }, isBL ? e.lastHit : e.lastBypass), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("button", { className: "icon-btn" }, /* @__PURE__ */ React.createElement(window.I.Edit, null)))))))));
  }
  ...
  function PageTracking() {
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "page-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", { className: "page-title" }, "Tracking"), /* @__PURE__ */ React.createElement("p", { className: "page-subtitle" }, "Operational state \xB7 SLO \xB7 cluster \xB7 GitOps \xB7 cert health")), /* @__PURE__ */ React.createElement("div", { className: "page-actions" }, /* @__PURE__ */ React.createElement("button", { className: "btn" }, /* @__PURE__ */ React.createElement(window.I.Refresh, null), " Refresh"))), /* @__PURE__ */ React.createElement("div", { className: "grid-12", style: { marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", { className: "col-6 card" }, /* @__PURE__ */ React.createElement(window.SectionHeader, { title: "SLO burn rate", sub: "30d rolling window" }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, [
      { name: "availability", val: "99.972%", target: "99.95%", burn: 0.4, tone: "up" },
      { name: "overhead p95", val: "12.4ms", target: "30ms", burn: 0.2, tone: "up" },
      { name: "overhead p99", val: "94\xB5s", target: "100\xB5s", burn: 1.8, tone: "warn" },
      { name: "audit delivery", val: "99.94%", target: "99.9%", burn: 0.3, tone: "up" }
    ].map((s) => /* @__PURE__ */ React.createElement("div", { key: s.name, style: { display: "grid", gridTemplateColumns: "120px 80px 80px 1fr 60px", gap: 10, alignItems: "center", fontSize: 12 } }, /* @__PURE__ */ React.createElement("span", null, s.name), /* @__PURE__ */ React.createElement("span", { className: "num", style: { color: `var(--${s.tone === "up" ? "up" : s.tone === "warn" ? "warn" : "down"})` } }, s.val), /* @__PURE__ */ React.createElement("span", { className: "dim" }, s.target), /* @__PURE__ */ React.createElement(window.Sparkline, { data: Array.from({ length: 24 }, () => 1 + Math.random() * s.burn), w: 180, h: 20, color: s.tone === "up" ? "#0ECB81" : s.tone === "warn" ? "#F0B90B" : "#F6465D" }), /* @__PURE__ */ React.createElement("span", { className: `pill ${s.tone}` }, s.burn, "\xD7 burn"))))), /* @__PURE__ */ React.createElement("div", { className: "col-6 card" }, /* @__PURE__ */ React.createElement(window.SectionHeader, { title: "Active alerts", sub: `${window.ALERTS.length} firing \xB7 0 silenced`, actions: /* @__PURE__ */ React.createElement("button", { className: "btn sm" }, "Alertmanager \u2192") }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } }, window.ALERTS.map((a, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { display: "flex", alignItems: "center", gap: 8, padding: 8, background: "var(--canvas-2)", borderRadius: 6, fontSize: 12 } }, /* @__PURE__ */ React.createElement("span", { className: `pill ${a.sev}` }, a.sev), /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { className: "mono", style: { color: "var(--ink)" } }, a.name), /* @__PURE__ */ React.createElement("div", { className: "dim", style: { fontSize: 11 } }, a.desc)), /* @__PURE__ */ React.createElement("span", { className: "dim" }, a.since)))))), /* @__PURE__ */ React.createElement("div", { className: "card", style: { marginBottom: 12 } }, /* @__PURE__ */ React.createElement(window.SectionHeader, { title: "Upstream pools", sub: `${window.UPSTREAMS.length} pools \xB7 ${window.UPSTREAMS.reduce((s, x) => s + x.healthy, 0)}/${window.UPSTREAMS.reduce((s, x) => s + x.members, 0)} healthy` }), /* @__PURE__ */ React.createElement("table", { className: "tbl tbl-compact" }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", null, "Pool"), /* @__PURE__ */ React.createElement("th", null, "Members"), /* @__PURE__ */ React.createElement("th", null, "LB"), /* @__PURE__ */ React.createElement("th", null, "Circuit"), /* @__PURE__ */ React.createElement("th", null, "p99"), /* @__PURE__ */ React.createElement("th", null, "req/s"), /* @__PURE__ */ React.createElement("th", null, "Status"))), /* @__PURE__ */ React.createElement("tbody", null, window.UPSTREAMS.map((p) => {
      const ok = p.healthy === p.members;
      const half = p.cb === "half-open";
      const open = p.cb === "open";
      return /* @__PURE__ */ React.createElement("tr", { key: p.name }, /* @__PURE__ */ React.createElement("td", { className: "mono" }, p.name), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 2 } }, Array.from({ length: p.members }).map((_, i) => /* @__PURE__ */ React.createElement("span", { key: i, style: { width: 8, height: 14, background: i < p.healthy ? "var(--up)" : "var(--down)", borderRadius: 1 } })), /* @__PURE__ */ React.createElement("span", { className: "num dim", style: { marginLeft: 6, fontSize: 11 } }, p.healthy, "/", p.members))), /* @__PURE__ */ React.createElement("td", { className: "mono dim" }, p.lb), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("span", { className: `pill ${open ? "err" : half ? "warn" : "ok"}` }, p.cb)), /* @__PURE__ */ React.createElement("td", { className: "num" }, p.p99 ? `${p.p99}ms` : "\u2014"), /* @__PURE__ */ React.createElement("td", { className: "num" }, p.rps.toLocaleString()), /* @__PURE__ */ React.createElement("td", null, ok && !open ? /* @__PURE__ */ React.createElement("span", { className: "pill ok" }, "healthy") : open ? /* @__PURE__ */ React.createElement("span", { className: "pill err" }, "down") : /* @__PURE__ */ React.createElement("span", { className: "pill warn" }, "degraded")));
    })))), /* @__PURE__ */ React.createElement("div", { className: "grid-12", style: { marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", { className: "col-6 card" }, /* @__PURE__ */ React.createElement(window.SectionHeader, { title: "Cluster peers", sub: "5 nodes \xB7 raft consensus" }), /* @__PURE__ */ React.createElement("table", { className: "tbl tbl-compact" }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", null, "ID"), /* @__PURE__ */ React.createElement("th", null, "Address"), /* @__PURE__ */ React.createElement("th", null, "Version"), /* @__PURE__ */ React.createElement("th", null, "Role"), /* @__PURE__ */ React.createElement("th", null, "Heartbeat"), /* @__PURE__ */ React.createElement("th", null, "Leases"))), /* @__PURE__ */ React.createElement("tbody", null, window.CLUSTER.map((c) => /* @__PURE__ */ React.createElement("tr", { key: c.id }, /* @__PURE__ */ React.createElement("td", { className: "mono" }, c.id), /* @__PURE__ */ React.createElement("td", { className: "mono dim" }, c.addr), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("span", { className: `pill ${c.skew ? "warn" : "neutral"}` }, c.ver)), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("span", { className: `pill ${c.role === "leader" ? "solid-yellow" : "neutral"}` }, c.role)), /* @__PURE__ */ React.createElement("td", { className: "num dim" }, c.lastHB), /* @__PURE__ */ React.createElement("td", null, c.leases.length === 0 ? /* @__PURE__ */ React.createElement("span", { className: "dim" }, "\u2014") : c.leases.map((l) => /* @__PURE__ */ React.createElement("span", { key: l, className: "pill info", style: { marginRight: 4 } }, l)))))))), /* @__PURE__ */ React.createElement("div", { className: "col-6 card" }, /* @__PURE__ */ React.createElement(window.SectionHeader, { title: "Cert freshness" }), /* @__PURE__ */ React.createElement("table", { className: "tbl tbl-compact" }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", null, "Host"), /* @__PURE__ */ React.createElement("th", null, "Issuer"), /* @__PURE__ */ React.createElement("th", null, "Source"), /* @__PURE__ */ React.createElement("th", null, "Expires"), /* @__PURE__ */ React.createElement("th", null, "Action"))), /* @__PURE__ */ React.createElement("tbody", null, window.CERTS.map((c) => {
      const tone = c.days < 7 ? "err" : c.days < 30 ? "warn" : "ok";
      return /* @__PURE__ */ React.createElement("tr", { key: c.host }, /* @__PURE__ */ React.createElement("td", { className: "mono" }, c.host), /* @__PURE__ */ React.createElement("td", { className: "dim" }, c.issuer), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("span", { className: "pill neutral" }, c.source)), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("span", { className: `pill ${tone}` }, c.days, "d")), /* @__PURE__ */ React.createElement("td", null, c.source === "acme" ? /* @__PURE__ */ React.createElement("button", { className: "btn sm" }, "Renew") : /* @__PURE__ */ React.createElement("span", { className: "dim" }, "\u2014")));
    }))))), /* @__PURE__ */ React.createElement("div", { className: "card" }, /* @__PURE__ */ React.createElement(window.SectionHeader, { title: "GitOps sync", sub: "auto-pull every 60s from main", actions: /* @__PURE__ */ React.createElement("button", { className: "btn sm" }, "Force resync") }), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 14, fontSize: 12 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "field-label" }, "Repo"), /* @__PURE__ */ React.createElement("div", { className: "mono" }, "git@github.com:org/aegis-config")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "field-label" }, "Branch"), /* @__PURE__ */ React.createElement("span", { className: "pill neutral" }, "main")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "field-label" }, "Last sync"), /* @__PURE__ */ React.createElement("span", { className: "num" }, "14s ago")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "field-label" }, "Drift"), /* @__PURE__ */ React.createElement("span", { className: "pill ok" }, "none")), /* @__PURE__ */ React.createElement("div", { style: { gridColumn: "1 / -1" } }, /* @__PURE__ */ React.createElement("div", { className: "field-label" }, "HEAD commit"), /* @__PURE__ */ React.createElement("div", { className: "mono", style: { fontSize: 11 } }, /* @__PURE__ */ React.createElement("span", { style: { color: "var(--brand-yellow)" } }, "a8b1f2c"), " ", /* @__PURE__ */ React.createElement("span", { className: "dim" }, "\u2014 update sqli-007 risk threshold (admin, 17:09)"), /* @__PURE__ */ React.createElement("span", { className: "pill ok", style: { marginLeft: 8 } }, "signature verified"))))));
  }
  Object.assign(window, {
    PageOverview,
    PageLiveFeed,
