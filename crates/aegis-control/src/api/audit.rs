...
// PE-1 (2026-07-04, committee round-2 🔴3): `WitnessState` /
// `WitnessHandler` / `WitnessLagResponse` removed together with the
// `GET /api/audit/witness` endpoint — schema-only surface whose
// signing runtime was deleted 2026-05-17 (F-CRITICAL-006) and whose
// `update()` had zero production callers. Real chain anchoring is a
// future audit-durability feature, not a stub.
