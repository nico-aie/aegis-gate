...
Handled by the dry-run validator in [`config-hot-reload.md`](../control-plane/config-hot-reload.md):
...
See [`ha-clustering.md`](../operations/ha-clustering.md) for split-brain safety.
...
fires first wins. See `docs/data-plane/adaptive-load-shedding.md` (P7) and
`docs/observability/audit-logging.md` (P8) for the full mechanics.
